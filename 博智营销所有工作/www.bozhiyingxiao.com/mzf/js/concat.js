$(function(){
    ...
    function createMap(){
        ...
        var point = new BMap.Point(108.898768,34.21975);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"魔之方科技",content:"C北2610",point:"108.899011|34.219594",isOpen:0,icon:{w:23,h:25,l:23,t:21,x:9,lb:12}}
		 ];
    //创建marker
    function addMarker(){
