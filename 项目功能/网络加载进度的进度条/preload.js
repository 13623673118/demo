...
$.preLoad = {
    PageLoading: function(options) {
        var defaults = {
            ...
            css: '<style> body{margin:0} .load-wrap{width:100%;height:3px;position:absolute;top:0;left:0;background:transparent} #pre-load{position:fixed;top:0;height:2px;background:#2085c5;transition:opacity .5s linear} #pre-load span{position:absolute;width:150px;height:2px;-webkit-border-radius:100%;opacity:1;right:-10px;-webkit-animation:pulse 2s ease-out 0s infinite}@-webkit-keyframes pulse{30%{opacity:.6}60%{opacity:0}to{opacity:.6}}</style>'
            //进度条样式位置可以自己修改
        }
