...
sHover.prototype.hoverOut=function(d,c,f){
	...
	if(this.trigger(c,"out",g)){
		...
		switch(a){
			case 0:this.startMove(f,{"top":-c.size.height,"left":0,"opacity":b});
			break;
			case 2:this.startMove(f,{"top":c.size.height,"left":0,"opacity":b});
			break;
			case 1:this.startMove(f,{"left":c.size.width,"top":0,"opacity":b});
			break;
			case 3:this.startMove(f,{"left":-c.size.width,"top":0,"opacity":b});
			break
		}
	}
};
...
sHover.prototype.myAddEvent=function(c,a,b){
	if(c.attachEvent){
		c.attachEvent("on"+a,function(){b.call(this)})
	}else{
