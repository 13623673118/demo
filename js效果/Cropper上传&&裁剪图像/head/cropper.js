...
(function (factory) {
  ...
  function getSourceCanvas(image, data) {
    ...
    var dstX = 0;
    var dstY = 0;
    var dstWidth = data.naturalWidth; //图片的原始宽度
    var dstHeight = data.naturalHeight; //图片的原始高度
    var rotate = data.rotate; //获取旋转角度
    var scaleX = data.scaleX; //获取x轴的缩放比例
    var scaleY = data.scaleY; //获取y轴的缩放比例
